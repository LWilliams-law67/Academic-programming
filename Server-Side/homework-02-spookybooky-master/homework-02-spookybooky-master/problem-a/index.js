...
//Define a new variable `motto` for the value "UWF is my school"
let motto = "UWF is my school";
...
//Use a String method to replace the word "UWF" in the `motto` variable with
//the words "The University of West Florida". The new value should be re-assigned to the
//`motto` variable.
//Log out the updated motto.
motto = motto.replace("UWF", "The University of West Florida");
console.log(motto);
