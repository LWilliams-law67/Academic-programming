...
void summary::printSummary(){
	...
	for(int i = 0; i < today.size(); i++){
		if(today[i].getTransactionID() != 0){
			cout << "ID: " << today[i].getTransactionID();
			cout << " ITEM: " << today[i].getItemName();
			cout << endl;
			cout << "TIME: ";
			cout << today[i].getTransactionTime();
			cout << endl;
			cout << "COST: " << today[i].getItemCost();
			cout << " SALE: " << today[i].getItemSell();
			cout << " PROFIT: " << today[i].getTransactionProfit();
			cout << endl;
			cout << endl;
		}
		else
